...
def get_args():
    custom_parameters = [
        ...
        {"name": "--logger", "type": str, "default": "tensorboard", "help": "Logger to use: tensorboard or wandb"},
        {"name": "--wandb_project", "type": str, "default": "HoST", "help": "Wandb project name"},
        {"name": "--wandb_entity", "type": str, "default": None, "help": "Wandb entity (team or user)"},
    ]
    # parse arguments
